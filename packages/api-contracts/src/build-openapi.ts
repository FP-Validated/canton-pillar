...
SearchQuery:s.SearchQuery, SearchResponse:s.SearchResponse, ExportJob:s.ExportJob, ExportCreateRequest:s.ExportCreateRequest, ExportDownloadUrlResponse:s.ExportDownloadUrlResponse, ExportJobListResponse:s.ExportJobListResponse, ReportTemplate:s.ReportTemplate, ReportTemplateCreateRequest:s.ReportTemplateCreateRequest, ReportTemplateListResponse:s.ReportTemplateListResponse, ReportTemplateRunResponse:s.ReportTemplateRunResponse, ExportDestination:s.ExportDestination, ExportDestinationCreateRequest:s.ExportDestinationCreateRequest, ExportDestinationListResponse:s.ExportDestinationListResponse,
...
export function buildOpenApi() {
  ...
  add('/v1/search', op('get','/v1/search','search','query','SearchResponse'));
  add('/v1/exports', {...op('post','/v1/exports','exports','create','ExportJob','ExportCreateRequest'),...op('get','/v1/exports','exports','list','ExportJobListResponse')}); add('/v1/exports/{id}', op('get','/v1/exports/{id}','exports','retrieve','ExportJob')); add('/v1/exports/{id}/cancel', op('post','/v1/exports/{id}/cancel','exports','cancel','ExportJob')); add('/v1/exports/{id}/download_url', op('post','/v1/exports/{id}/download_url','exports','downloadUrl','ExportDownloadUrlResponse'));
  add('/v1/report_templates', {...op('post','/v1/report_templates','report_templates','create','ReportTemplate','ReportTemplateCreateRequest'),...op('get','/v1/report_templates','report_templates','list','ReportTemplateListResponse')}); add('/v1/report_templates/{id}', op('get','/v1/report_templates/{id}','report_templates','retrieve','ReportTemplate')); add('/v1/report_templates/{id}/archive', op('post','/v1/report_templates/{id}/archive','report_templates','archive','ReportTemplate')); add('/v1/report_templates/{id}/run', op('post','/v1/report_templates/{id}/run','report_templates','run','ReportTemplateRunResponse'));
  add('/v1/export_destinations', {...op('post','/v1/export_destinations','export_destinations','create','ExportDestination','ExportDestinationCreateRequest'),...op('get','/v1/export_destinations','export_destinations','list','ExportDestinationListResponse')}); add('/v1/export_destinations/{id}/disable', op('post','/v1/export_destinations/{id}/disable','export_destinations','disable','ExportDestination'));
