...
export const ErrorCode = z.enum(['invalid_parameter', 'missing_required_parameter', 'unsupported_expand', 'metadata_too_large', 'network_invalid', 'network_not_bound', 'idempotency_key_required', 'idempotency_key_reused', 'insufficient_holding', 'asset_not_transferable', 'intent_already_final', 'ledger_command_rejected', 'ledger_completion_timeout', 'projection_lag_exceeded', 'rate_limit_exceeded', 'api_key_expired', 'api_version_unsupported', 'webhook_signature_verification_failed']);
